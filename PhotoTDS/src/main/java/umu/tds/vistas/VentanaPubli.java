...
public class VentanaPubli {
	...
	private JLabel labelNumLikes, labelCommNum;
	...
	private void dibujar() {
		...
		gbl_panelPubli.columnWeights = new double[]{1.0, Double.MIN_VALUE};
		...
		gbl_panelFotoInfo.columnWidths = new int[]{0, 0};
		gbl_panelFotoInfo.rowHeights = new int[]{24, 0, 0, 0};
		...
		JPanel panelLikedComm = new JPanel();
		GridBagConstraints gbc_panelLikedComm = new GridBagConstraints();
		gbc_panelLikedComm.fill = GridBagConstraints.BOTH;
		gbc_panelLikedComm.gridx = 0;
		gbc_panelLikedComm.gridy = 0;
		panelFotoInfo.add(panelLikedComm, gbc_panelLikedComm);
		GridBagLayout gbl_panelLikedComm = new GridBagLayout();
		gbl_panelLikedComm.columnWidths = new int[]{128, 128, 0};
		gbl_panelLikedComm.rowHeights = new int[]{0, 0};
		gbl_panelLikedComm.columnWeights = new double[]{0.0, 0.0, Double.MIN_VALUE};
		gbl_panelLikedComm.rowWeights = new double[]{1.0, Double.MIN_VALUE};
		panelLikedComm.setLayout(gbl_panelLikedComm);
		...
		panelLikedComm.add(panelLikes, gbc_panelLikes);
		GridBagLayout gbl_panelLikes = new GridBagLayout();
		gbl_panelLikes.columnWidths = new int[]{24, 107, 0};
		gbl_panelLikes.rowHeights = new int[]{32, 0};
		gbl_panelLikes.columnWeights = new double[]{0.0, 0.0, Double.MIN_VALUE};
		...
		gbc_labelLikesIcon.insets = new Insets(0, 5, 0, 5);
		...
		panelLikedComm.add(panelComm, gbc_panelComm);
